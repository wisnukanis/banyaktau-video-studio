...
function buildPrompt(input, context) {
  ...
  return [
    ...
    "- Untuk setiap scene, isi stockQuery dengan kata kunci pencarian B-roll dalam Bahasa Inggris (WAJIB bahasa Inggris), maksimal 3 kata, SANGAT SPESIFIK dan WAJIB MENYEBUTKAN NAMA BENDA FISIK / OBJEK NYATA (CONCRETE OBJECT NOUN). Contoh BAIK: 'stainless steel spoon', 'metal spoon eating', 'iron ship hull', 'red blood cells', 'honey jar'.",
