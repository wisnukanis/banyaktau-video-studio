...
export function publicConfig() {
  return {
    ...
    providers: {
      ...
      videoProvider: clean(process.env.VIDEO_PROVIDER || "dinoiki-gemini"),
      videoBaseUrl: cleanBaseUrl(process.env.VIDEO_BASE_URL || "https://ai.dinoiki.com"),
      ...
      videoApiKeySet: Boolean(process.env.VIDEO_API_KEY || process.env.DINOIKI_API_KEY),
